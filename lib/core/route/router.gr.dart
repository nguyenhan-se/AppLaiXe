...
class AppRouter extends _i2.RootStackRouter {
  ...
  List<_i2.RouteConfig> get routes => [
        ...
        _i2.RouteConfig(HomeRoute.name, path: '/home', children: [
          _i2.RouteConfig(CarBookingTab.name,
              path: 'main',
              parent: HomeRoute.name,
              children: [
                _i2.RouteConfig(PassengerRoute.name,
                    path: '', parent: CarBookingTab.name),
                _i2.RouteConfig(ChairBookingRoute.name,
                    path: 'chair-booking', parent: CarBookingTab.name),
                _i2.RouteConfig(ConfirmBookingRoute.name,
                    path: 'confirm-booking-page', parent: CarBookingTab.name),
                _i2.RouteConfig(UserBookingRoute.name,
                    path: 'user-booking-page', parent: CarBookingTab.name)
              ]),
...
/// generated route for
/// [_i2.EmptyRouterPage]
class CarBookingTab extends _i2.PageRouteInfo<void> {
  const CarBookingTab({List<_i2.PageRouteInfo>? children})
      : super(CarBookingTab.name, path: 'main', initialChildren: children);

  static const String name = 'CarBookingTab';
}
